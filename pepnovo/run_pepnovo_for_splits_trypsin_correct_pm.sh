...
for mgf_file in ./mgf_splits/*.mgf; do
    ...
    pepnovo -file "$mgf_file" -model CID_IT_TRYP -PTMs C+57:M+16 -digest TRYPSIN -correct_pm -num_solutions 10 > "./scores_trypsin_correct_pm/pepnovo_scores_${filename}.txt" &
done
